...
# region Operator Management
	...
	def manageOpClone(self, fam_name, clone, tox_file_version=None, op_name=None):
		"""
		Modify the placed operator before it is added to the scene.
		"""
		family_owner = self.GetFamilyOwner(fam_name)
		self.OpManager.manageOpClone(family_owner, clone, tox_file_version=tox_file_version, op_name=op_name)
		return clone
